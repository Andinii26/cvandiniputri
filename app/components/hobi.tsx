...
import hobby2 from '../hobby2.jpeg';
import hobby3 from '../hobby3.jpg';
import hobby4 from '../hobby4.jpg';

const HobbiesGallery: React.FC = () => {
  const hobbies = [
    { id: 1, title: 'Membaca', image: hobby1 },
    { id: 2, title: 'Membuat Kue', image: hobby2 },
    { id: 3, title: 'Badminton', image: hobby3 },
    { id: 4, title: 'Menonton', image: hobby4 },
  ];
