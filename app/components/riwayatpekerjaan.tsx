...
return ( 
    <div className="container mx-auto p-2 text-center pt-20">
      ...
      <RowPekerjaan sebagai="Anak Magang" instansi="PT. SIMELDA" tahun="Juli 2023"/>
      <RowPekerjaan sebagai="Anak Magang" instansi="SMA YADIKA CICALENGKA" tahun="JUNI-JULI 2024"/>
